...
.btnArea input { 
	background: url("http://img.echosting.cafe24.com/skin/base_ko_KR/member/btn_member_join1.gif");
...
<body>
	...
	<div class="memberJoin">
		...
		<div class="boardWrite">
			<form id="join_form" action="${pageContext.request.contextPath }/member/join" method="post">
				<table border="1">
				<tbody>
					<tr>
						<th scope="row">
...
<!-- 			<h3>추가 정보</h3>
	    	...
	    	<div class="agreeArea">
	       		<div class="agree">
	           		<p>
	           			제1조(목적)<br>
	           			이 약관은 SOLLABO가 운영하는 쇼핑몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.<br>
	           			※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
	           		</p>
	           		<p>
	           			제2조(정의)<br>
	           			① “몰”이란 쇼핀이 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
	           		...
	           		<p>
	           			...
	           			① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자등을 이용자가 쉽게 알 수 있도록 쇼핑몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.<br>
	           		...
	           		<p>
	           			...
	           			③ “몰”이 제공하기로 이용자와 계약을 체결한 서비스의 내용을 재화등의 품절 또는 기술적 사양의 변경 등의 사유로 변경할 경우에는 그 사유를 이용자에게 통지 가능한 주소로 즉시 통지합니다.<br>④ 전항의 경우 “몰”은 이로 인하여 이용자가 입은 손해를 배상합니다. 다만, “몰”이 고의 또는 과실이 없음을 입증하는 경우에는 그러하지 아니합니다.
	           		</p>
	           		<p>
	           			제5조(서비스의 중단)<br>
	           		...
	           		<p>
	           			...
	           			8. 기타 전자적 지급 방법에 의한 대금 지급 등</p><p>제12조(수신확인통지․구매신청 변경 및 취소)<br>
	    	...
	    	<div class="agreeArea">
		        <div class="agree">
	            	...
	            	<p>다. <span style="font-size: 9pt;">마케팅 및 광고에 활용</span></p>
	            	...
	            	<p>-보존기간 : 5년</p><p>o 대금 결제 및 재화 등의 공급에 관한 기록</p>
	            	<p>-보존이유: 전자상거래등에서의소비자보호에관한법률</p>
	            	<p>-보존기간 : 5년 </p>
	            	...
	            	<p>#개인정보의 위탁 처리</p>
	            	<p>“업체명”은 서비스 향상을 위해 관계법령에 따라 회원의 동의를 얻거나 관련 사항을 공개 또는 고지 후 회원의 개인정보를 외부에 위탁하여 처리하고 있습니다. </p>
	            	<p>“업체명”의 개인정보처리 수탁자와 그 업무의 내용은 다음과 같습니다.</p>
	            	<p>- 수탁자 : ㈜스냅컴퍼니(알림전송수탁업체 : ㈜엠티에스컴퍼니)</p>
	            	<p>- 위탁 업무 내용 : 신규 서비스(제품) 개발 및 맞춤 서비스 제공, 이벤트 및 광고성 정보 및 참여기회 제공</p>
	        ...
	        <div class="btnArea">
		        <input type="submit" value=""><a href="/sollabo/member/joinResult" onclick=""></a>
		    </div>
